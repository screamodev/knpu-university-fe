...
- `/education/digital-center` ← https://hnpu.edu.ua/uk/division/centr-cyfrovizaciyi-osvity —
  ...
  **Друга ітерація (за фідбеком клієнта):** сторінку перебудовано за макетом кафедри — тіло з
  випадаючими списками (9 акордеонів, «Стажування» вкладене в «Платформу MOODLE»), кнопка Наказу
  №251, картка контактів (адреса, cdo@hnpu.edu.ua) і блок «Оголошення» збоку, календар подій
  фреймом, унизу — новини центру. Блок «Інструкції та документи» зі сторінки прибрано (рядки
  `documents` лишилися в Directus). Архів новин зі старої сторінки
  https://hnpu.edu.ua/uk/division/novyny-centru-cyfrovizaciyi-osvity перенесений у `articles`:
  **35 статей** (2018–2022) у новій категорії `centr-cyfrovizaciyi-osvity`. Скрипти —
  `knpu-university-be/migration/digital-center/`.
