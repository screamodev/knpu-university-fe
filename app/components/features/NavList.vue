...
<template>
  <ul class="list-none flex items-center gap-0.5">
    ...
    >
      <button
        type="button"
        class="flex items-center gap-1.5 py-7 px-4 text-sm font-medium text-navy no-underline cursor-pointer border-none bg-transparent font-geologica whitespace-nowrap transition-colors duration-280 relative after:content-[''] after:absolute after:bottom-0 after:left-4 after:right-4 after:h-[3px] after:bg-gold after:scale-x-0 after:origin-center after:transition-transform after:duration-280 after:rounded-t group-hover:text-gold group-hover:after:scale-x-100"
      >
        {{ t(item.labelKey) }}
        <span
          class="w-3 h-3 border-r-[1.5px] border-b-[1.5px] border-current rotate-45 -translate-y-0.5 mt-0.5 transition-transform duration-280 group-hover:rotate-[-135deg] group-hover:-translate-y-0.5"
          aria-hidden
        />
      </button>
