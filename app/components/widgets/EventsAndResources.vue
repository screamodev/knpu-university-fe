        ...
        <div>
          ...
          <div class="flex flex-col gap-4">
            <NuxtLink
              ...
              class="grid grid-cols-[80px_1fr_auto] items-center gap-5 py-5 px-6 border-[1.5px] border-border rounded-12 no-underline transition-all duration-280 bg-white hover:border-gold hover:translate-x-1"
            >
