...
const LEVELS = {
  bachelor: {
    from: 'Освітні програми першого (бакалаврського) рівня вищої освіти 2023',
    to: 'Освітні програми підготовки здобувачів другого',
  },
  master: {
    from: 'Освітні програми другого (магістерського) рівня вищої освіти 2025',
    to: 'Освітні програми підготовки здобувачів третього',
  },
  phd: {
    from: 'Освітні програми третього (освітньо-наукового) рівня вищої освіти 2023',
